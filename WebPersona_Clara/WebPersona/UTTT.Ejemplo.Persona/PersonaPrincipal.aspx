...
<body style="background: #DFF3D7">
    ...
    <div style="font-weight: bold">
        ...
        <div class="table-responsive">
             ...
             <asp:GridView ID="dgvPersonas" runat="server" 
                ...
                BorderColor="Black" BorderStyle="None" BorderWidth="2px" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="strFechaNacimiento" HeaderText="Fecha Nacimiento" ReadOnly="True" 
                        SortExpression="strFechaNacimiento" />
    ...
    <asp:LinqDataSource ID="DataSourcePersona" runat="server" 
        ...
        Select="new (strNombre, strAPaterno, strAMaterno, CatSexo, strClaveUnica, id, strFechaNacimiento)" 
